...
INNER JOIN registry_process rp on rp.req_id = r.req_id 
INNER JOIN pc_process pc ON hp.req_id=pc.req_id
...
WHERE hp.status_id = 5  AND hp.hos_id=:id";
        ...
        <table id="myTable" class="display">
            ...
            <tbody>
                ...
                foreach ($data as $row) {
                    ...
                    $document=$row['form'];
                    echo '<tr>';
                    echo '<td style="text-align: center;"><a href="hos_viewform.php?req_id=' . $row['req_id'] . '" style="color: black;">' . htmlspecialchars($row['s_pin']) . '</a></td>';
                    ...
                    echo '<input type="hidden" name="pn" value="'. htmlspecialchars($row['s_pin']) .'">';
                    echo '<a class="decline-button"  href="DownloadForm.php?file=' . urlencode($document) . '" value="' . $row['req_id'] . '" onclick="showPopup()">Download Form</a>';
                    echo '</form>';
                    echo '</td>';
                    echo '</tr>';
                }
        ...
        <ul class="menu_items">
            ...
            <li class="item">
                <a href="#" class="nav_link">
                    ...
                    <span class="navlink text-wrap text-center">New Programme Coordinator</span>
                </a>
            </li>-->
            <li class="item">

...
<div class="box-container">
    ...
    <div class="report-container" style="margin-top:125px;">
        ...
        <table id="myTable" class="display ">
            <thead>
                <tr class="header ">
                    <th class="text-center text-dark" style="width:15%;" >Student ID</th>
                    <th class="text-center text-dark" style="width:20%;">Student Name</th>
                    <th class="text-center text-dark" style="width:15%;">Request Name</th>
                    <th  class="text-center text-dark" style="width:15%;">Date</th>

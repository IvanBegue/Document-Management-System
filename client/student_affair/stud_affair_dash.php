...
<!DOCTYPE html>
    ...
    <body>
        ...
        <a href="../student_affair/saindex.php">
        <img src="images/UTM.png" alt="Description of the image"></i>
        </a>
        <h1 class="text-secondary" style="margin-left:370px;">STUDENT AFFAIR DEPARTMENT</h1>
    </div>
...
<nav class="sidebar">
    <ul class="menu_items">
        ...
        <!-- start -->
        <li class="item">
            <a href="./saindex.php" class="nav_link">
        ...
        <li class="item">
                <a href="./studHistory.php" class="nav_link">
                    <span class="navlink_icon">
            ...
            <li class="item">
    <a href="./stud_affair_pass.php" class="nav_link">
        <span class="navlink_icon">
            <i class="bx bx-cog"></i>
        </span>
...
<li class="item">
    ...
    <?php   
            $stmtFN=$pdo->prepare("SELECT CONCAT(sa_lname, ' ', sa_fname) AS FN FROM student_affairs where  sa_id= :id");
            $stmtFN->execute(array(":id"=> $_SESSION["said"]));

...
if (isset($_POST["btnapprove"])) {
  try {
      ...
      $updateRegistrySql = "UPDATE dc_process SET status_id = 1, dc_id = :dc_id, date_process = :date_process WHERE req_id = :id";
      $updateRegistryStmt = $pdo->prepare($updateRegistrySql);
      $updateRegistryStmt->execute(array(":id" => $reqId, ":dc_id" => $dcId, ":date_process" => $dateProcess));
      ...
      $by="Dear Student, your request has been approved by the dissertation committee";
      $nm=$fullName;
...
if (isset($_POST["btnreject"])) {
  ...
  try {
    ...
    $dateProcess = date("Y-m-d");
      // Update the status_id in dc_process
      $updateRegistrySql = "UPDATE dc_process SET status_id = 2, dc_id = :dc_id, date_process = :date_process WHERE req_id = :id";
      $updateRegistryStmt = $pdo->prepare($updateRegistrySql);
      $updateRegistryStmt->execute(array(":id" => $reqId, ":dc_id" => $dcId, ":date_process" => $dateProcess));
...
<div class="container">
    <h1 class="form-title">Student Request Form</h1>
      ...
      <div class="main-user-info">
        ...
        <?php
        //!add req_id
        $sql2=$pdo->prepare("SELECT status_id from dc_process where req_id=:id");
        ...
        ?>
        <a href="../dissertation_commitee/dc_viewform.php" class="btn btn-primary "type="button">Back Home</a>

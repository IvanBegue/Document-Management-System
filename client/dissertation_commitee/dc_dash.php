...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="logo_item">
            ...
            <img src="../dissertation_commitee/images/UTM.png" alt="Description of the image"></i>
          
        </div>
        <h1 class="text-secondary" style="margin-left: 50px;">DISSERTATION COMMITTEE</h1>
...
<nav class="sidebar">
    <ul class="menu_items">
        ...
        <!-- start -->
        <li class="item">
            <a href="../dissertation_commitee/dcIndex.php" class="nav_link">
        ...
        <li class="item">
                <a href="../dissertation_commitee/dc_history.php" class="nav_link">
                    <span class="navlink_icon">
            ...
            <li class="item">
    <a href="./dc_pass.php" class="nav_link">
        <span class="navlink_icon">
            <i class="bx bx-cog"></i>
        </span>
  ...
  <li class="item">
    ...
    <?php   
            $stmtFN=$pdo->prepare("SELECT CONCAT(dc_lname, ' ', dc_fname) AS FN FROM disertation_commitee where  dc_id= :id");
            $stmtFN->execute(array(":id"=> $_SESSION["dcid"]));
